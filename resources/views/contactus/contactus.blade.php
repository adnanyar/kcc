                    ...
                    <div class="container-fluid shadow " style="height:100%; width: 100%;">
                        ...
                        <form action="/action_page.php" class="was-validated">
                          <div class="form-group">
                            ...
                            <input  type="text" class="form-control shadow" id="uname" placeholder="Enter username" name="uname" required>
                          </div>
                          <div class="form-group">
                            <label for="pwd">Email</label>
                            <input  type="password" class="form-control shadow" id="pwd" placeholder="Enter password" name="pswd" required>
                          </div>
                          <div class="form-group">
                            <label for="pwd">Description</label>
                            <textarea type="text" class="form-control shadow" id="description" placeholder="Enter Description" name="pswd" required style="height: 140px;"></textarea>
                          </div>
